...
int main(){
    ...
    float area,PIB,densidade_populacional,PIB_percatpita;
    ...
    nas respctivas variáveis*/
     ...
     printf(" hab/Km²\n");
     printf("O valor do PIB_Percapita da cidade para a Carta_1 e´:%.2f",PIB_percatpita);
     printf(" reais\n");
     ...
     printf(" hab/Km²\n");
     printf("O valor do PIB_Percapita da cidade para a Carta_2 e´:%.2f",PIB_percatpita);
     printf(" reais\n");
     return 0;  
}